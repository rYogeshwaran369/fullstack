    ...
    <>
      <Row gutter={30}>
        <Col xs={16}>
          <BarChart
            ...
            labels={[
              ...
              '2022-01-26', '2022-01-27', '2022-01-28', '2022-01-29', '2022-01-30', '2022-02-01',
              '2022-02-02', '2022-02-03', '2022-02-04', '2022-02-05', '2022-02-06', '2022-02-07',
              '2022-02-08', '2022-02-09', '2022-02-10', '2022-02-11', '2022-02-12', '2022-02-13',
        ...
        <Col xs={8}>
          <PieChart
            title="Sales Report"
            data={[112332, 123221, 432334]}
            type="donut"
            labels={['Chocolates','Toys','Other']}
          />
        </Col>
      </Row>
      <Row gutter={30}>
